/* ============================================================================
   ...
   Add to any page:  <script src="/js/liq-icons.js?v=2" defer></script>
============================================================================ */
(function () {
  "use strict";
  ...
  var CSS =
    ...
    ".calc-ico.liq-tile{width:52px;height:52px;border-radius:14px;font-size:0;" +
    "background:linear-gradient(135deg,rgba(79,107,255,.12),rgba(155,107,255,.12))}" +
    "html[data-theme='dark'] .calc-ico.liq-tile{background:linear-gradient(135deg,rgba(91,141,255,.18),rgba(192,123,255,.18))}" +
